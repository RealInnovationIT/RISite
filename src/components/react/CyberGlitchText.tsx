  ...
  return (
    ...
    >
      ...
      {isHovered && (
        <>
          <motion.span
            className="absolute top-0 left-[-2px] z-0 text-emerald-500 opacity-70 mix-blend-screen"
          ...
          <motion.span
            className="absolute top-0 left-[2px] z-0 text-cyan-400 opacity-70 mix-blend-screen"
            initial={{ x: 0, opacity: 0 }}
            animate={{ x: [2, -2, 1, -3, 0], opacity: [0, 0.8, 0.4, 0.9, 0] }}
          ...
          <motion.div
            className="absolute inset-0 bg-white/5 z-20 pointer-events-none mix-blend-overlay"
